...
<article class="markdown-body entry-content p-5" itemprop="text">
  <h1><a id="user-content--BackEndShop-API" class="anchor" aria-hidden="true" href="#-BackEndShop-API"><svg
    ...
    <g-emoji class="g-emoji" alias="notebook"
      fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/1f4d3.png">📓</g-emoji> CSDM
  </h1>
  ...
  <p>CSDM is a spring boot application, that manage books</p>
  ...
  <p>For more help getting started with Spring boot, view the
      ...
      <br>
  <p>Now you can build your own project using CSDM by yourself.</p>
  </article>
